...
def make_transformer_dut(params):
    ...
    modle = DummyTransformer(
        num_layers = params["model_num_layers"],
        num_heads = params["model_num_heads"],
        emb_dim = params["model_emb_dim"],
        mlp_dim = params["model_mlp_dim"],
        seq_len = params["model_seq_len"],
        bias = params["model_bias"],
        bits = params["model_bits"],
        norm = params["model_norm"],
        mask = params["model_mask"],
        positional_encoding = params["model_positional_encoding"],
    )

    # Get the configured sequence length and embedding dimension to generate
    # test inputs
    seq, dim = params["model_seq_len"], params["model_emb_dim"]
...
def build_transformer(params):
    ...
    seq_len, emb_dim = params["model_seq_len"], params["model_emb_dim"]
